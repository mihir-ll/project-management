...
@Injectable()
export class ProjectUpdateRepository extends SolidBaseRepository<ProjectUpdate> {
    constructor(
        ...
        super(ProjectUpdate, dataSource, requestContextService, securityRuleRepository);
    }
}