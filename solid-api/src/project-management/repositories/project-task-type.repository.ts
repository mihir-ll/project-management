...
@Injectable()
export class ProjectTaskTypeRepository extends SolidBaseRepository<ProjectTaskType> {
    constructor(
        ...
        super(ProjectTaskType, dataSource, requestContextService, securityRuleRepository);
    }
}